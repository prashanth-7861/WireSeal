...
const MODES: { id: AppMode; icon: typeof Server; title: string; description: string; accent: string; hoverBg: string; ring: string }[] = [
  {
    ...
    icon: Server,
    title: "Server Mode",
    description: "Host secure access to your home network and manage device connections",
  ...
  },
  {
    ...
    icon: Terminal,
    title: "Client Mode",
    description: "Connect to your home network remotely and access SSH terminal",
