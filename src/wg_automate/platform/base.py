"""Abstract platform adapter base class for wg-automate.
...
class AbstractPlatformAdapter(ABC):
    """Contract for all platform-specific wg-automate adapters.
    ...
    def check_privileges(self) -> None:
        """Raise PrivilegeError if wg-automate is not running as root/Administrator.
