...
Write-Host "  Add client (LAN):      wireseal add-client bob --tunnel-mode split-lan"
Write-Host "  Add client (full):     wireseal add-client carol --tunnel-mode full"
...
Write-Host ""
Write-Host "Tunnel modes:  split-vpn (VPN peers only, default)"
Write-Host "               split-lan (VPN + server LAN - access NAS, Plex, cameras)"
Write-Host "               full      (route ALL traffic through server)"
Write-Host ""
